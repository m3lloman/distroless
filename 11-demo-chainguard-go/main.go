...
func indexHandler(w http.ResponseWriter, r *http.Request) {
	fmt.Fprint(w, `<h2>Ping Tool (Chainguard Go)</h2><form action='/ping'>Host: <input name='host' value='8.8.8.8'><input type='submit' value='Ping'></form>`)
}
...
func pingHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Intentionally vulnerable: user input passed to sh -c.
	// Try: ?host=8.8.8.8; id
